...
CURRENT_BEST_MODEL_ID = "drop_distance_to_3m_high_refined50"
CURRENT_BEST_FRAMEWORK_ID = FEATURE_PHASE_BASE_FRAMEWORK_ID
CURRENT_BEST_FEATURE_PROFILE_ID = "drop_distance_to_3m_high"
CURRENT_BEST_TUNED_PPO_ID = "refined50"
CURRENT_BEST_OUTPUT_ROOT = "outputs/top_candidate_reruns/refined50"
CURRENT_BEST_SELECTION_RULE = "three_seed_validation_mean_reward_then_validation_spearman"
CURRENT_BEST_VALIDATION_MEAN_REWARD = 0.7011724526701295
CURRENT_BEST_VALIDATION_MEAN_SPEARMAN = 0.595439868217765
CURRENT_BEST_TEST_MEAN_REWARD = 0.7449408326370087
CURRENT_BEST_TEST_MEAN_SPEARMAN = 0.6565424625995037
