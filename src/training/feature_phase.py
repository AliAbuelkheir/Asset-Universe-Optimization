...
def _build_cli_parser() -> argparse.ArgumentParser:
    ...
    plan_parser.add_argument("--output-root", default=None, help="Experiment root directory. Defaults to outputs/experiments.")
    ...
    run_parser.add_argument("--output-root", default=None, help="Experiment root directory. Defaults to outputs/experiments.")
    ...
    sync_parser.add_argument("--output-root", default=None, help="Experiment root directory. Defaults to outputs/experiments.")
