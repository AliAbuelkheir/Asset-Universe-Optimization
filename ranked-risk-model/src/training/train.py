...
def _to_summary_row(
    ...
    return {
        ...
        "TrainMeanHighRiskTop25Overlap": _metric(split_summary, comparison_protocol.training_split_name, "mean_high_risk_top25_overlap"),
        "ValidationMeanHighRiskTop25Overlap": _metric(split_summary, comparison_split, "mean_high_risk_top25_overlap"),
        "TestMeanHighRiskTop25Overlap": _metric(split_summary, "test", "mean_high_risk_top25_overlap"),
        "ValidationWorstHighRiskTop25Overlap": _metric(split_summary, comparison_split, "worst_high_risk_top25_overlap"),
        "TestWorstHighRiskTop25Overlap": _metric(split_summary, "test", "worst_high_risk_top25_overlap"),
        ...
        "InnerValidationMeanHighRiskTop25Overlap": _metric(split_summary, checkpoint_split, "mean_high_risk_top25_overlap"),
        "InnerValidationWorstHighRiskTop25Overlap": _metric(split_summary, checkpoint_split, "worst_high_risk_top25_overlap"),
