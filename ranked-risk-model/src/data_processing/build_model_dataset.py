...
def _build_cli_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        help="Feature profile to build. Base profile writes to data/ready by default; non-base profiles write to outputs/generated/datasets/feature_profiles/<id>/ unless --output-dir is set.",
    )
    parser.add_argument(
        "--output-dir",
        default=None,
