...
DEFAULT_OUTPUT_ROOT = ROOT / "outputs" / "generated" / "runs" / "top_candidates" / "refined50"
...
def _summary_row(candidate: TopCandidate, tuned_candidate: str, summary: dict[str, Any]) -> dict[str, Any]:
    return {
        ...
        "ValidationMeanHighRiskTop25Overlap": summary.get("ValidationMeanHighRiskTop25Overlap"),
        "ValidationWorstHighRiskTop25Overlap": summary.get("ValidationWorstHighRiskTop25Overlap"),
        ...
        "TestMeanHighRiskTop25Overlap": summary.get("TestMeanHighRiskTop25Overlap"),
        "TestWorstHighRiskTop25Overlap": summary.get("TestWorstHighRiskTop25Overlap"),
...
def select_winning_candidate(summary_frame: pd.DataFrame) -> dict[str, Any]:
    ...
    for optional_column in ("ValidationMeanHighRiskTop25Overlap", "TestMeanHighRiskTop25Overlap"):
        if optional_column not in summary_frame.columns:
            summary_frame[optional_column] = pd.NA
    ...
    grouped = (
        ...
        .agg(
            ...
            mean_validation_high_risk_top25_overlap=("ValidationMeanHighRiskTop25Overlap", "mean"),
            mean_test_reward=("TestMeanReward", "mean"),
            mean_test_spearman=("TestMeanSpearman", "mean"),
            mean_test_high_risk_top25_overlap=("TestMeanHighRiskTop25Overlap", "mean"),
        )
        .reset_index()
        .sort_values(
