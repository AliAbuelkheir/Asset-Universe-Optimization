...
DEFAULT_TRAINING_METHOD_ID = "ordered_cycle"
...
GENERATED_RUN_OUTPUT_DIR = f"{GENERATED_OUTPUT_DIR}/runs"
GENERATED_DATASET_OUTPUT_DIR = f"{GENERATED_OUTPUT_DIR}/datasets"
GENERATED_REPORT_OUTPUT_DIR = f"{GENERATED_OUTPUT_DIR}/reports"
BEST_MODEL_OUTPUT_DIR = "outputs/best_model"
FEATURE_PROFILE_OUTPUT_DIR = f"{GENERATED_DATASET_OUTPUT_DIR}/feature_profiles"
FEATURE_CANDIDATE_OUTPUT_DIR = f"{GENERATED_DATASET_OUTPUT_DIR}/feature_candidates"
FEATURE_PHASE_BASE_FRAMEWORK_ID = "pit_3m_flat_context"
FEATURE_PHASE_TOTAL_TIMESTEPS = 8192

# === Current Best Model Metadata ===
CURRENT_BEST_MODEL_ID = "downside_tail_ratio_3m_refined50"
CURRENT_BEST_FRAMEWORK_ID = FEATURE_PHASE_BASE_FRAMEWORK_ID
CURRENT_BEST_FEATURE_PROFILE_ID = "full_current_v1"
CURRENT_BEST_ADDITIVE_FEATURE_ID = "downside_tail_ratio_3m"
CURRENT_BEST_INPUT_FEATURE_SET_ID = "shadow_add_downside_tail_ratio_3m"
CURRENT_BEST_TUNED_PPO_ID = "refined50"
CURRENT_BEST_OUTPUT_ROOT = f"{GENERATED_RUN_OUTPUT_DIR}/tail_candidates/refined50"
CURRENT_BEST_SELECTION_RULE = "tail_aware_validation_high_risk_overlap_with_reward_spearman_guardrails"
CURRENT_BEST_VALIDATION_MEAN_REWARD = 0.708076
CURRENT_BEST_VALIDATION_MEAN_SPEARMAN = 0.604662
CURRENT_BEST_VALIDATION_MEAN_HIGH_RISK_TOP25_OVERLAP = 0.477208
CURRENT_BEST_TEST_MEAN_REWARD = 0.751464
CURRENT_BEST_TEST_MEAN_SPEARMAN = 0.665173
CURRENT_BEST_TEST_MEAN_HIGH_RISK_TOP25_OVERLAP = 0.494949
